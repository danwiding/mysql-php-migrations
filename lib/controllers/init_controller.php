...
//			}
		...
		try
		{
			if (false === MpmDbHelper::checkForDbTable())
			{
				...
				$sql1 = "CREATE TABLE IF NOT EXISTS `{$db_config->migrations_table}` ( `id` INT(11) NOT NULL AUTO_INCREMENT, `timestamp` DATETIME NOT NULL, `active` TINYINT(1) NOT NULL DEFAULT 0, `is_current` TINYINT(1) NOT NULL DEFAULT 0, PRIMARY KEY ( `id` ) ) ENGINE=InnoDB";
